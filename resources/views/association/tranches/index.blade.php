...
<div class="main-content">
  ...
  <section id="form-action-layouts">
    <div class="row">
      <div class="col-sm-12">
        <div class="content-header">الاشطر</div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" id="from-actions-top-left"></h4>
    
        </div>
        <div class="card-body">
          <a href="{{route($role.'-tranches-add')}}">اظافة</a>
          <div class="px-3">
            @include('association.tranches.table')
          </div>
        </div>
      </div>
      </div>
